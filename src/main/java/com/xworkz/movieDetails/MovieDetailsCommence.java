...
public class MovieDetailsCommence {
	...
	public static void main(String[] args) {
		...
		MovieDetailsDto dto = new MovieDetailsDto("Badava Rascal", "Shankar Guru", Language.KANNADA, 2021, 8.2);
...
//		
		...
		//System.out.println(dao.deleteMovieDetailsByMovie("Badava Rascal"));
	}
